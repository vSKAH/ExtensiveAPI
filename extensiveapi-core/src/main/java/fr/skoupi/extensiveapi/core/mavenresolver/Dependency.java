...
public class Dependency {
	...
	private final boolean onlyLink;
	 ...
	 */
	public Dependency (String groupId, String artifactId, String version, String repository, boolean onlyLink)
	{
	...
	{
		this(groupId, artifactId, version, "https://repo1.maven.org/maven2/", false);
	}
